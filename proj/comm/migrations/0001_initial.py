...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('comm', ['Order'])

        # Adding model 'OrderSpecification'
        db.create_table('comm_orderspecification', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('quantity', self.gf('django.db.models.fields.IntegerField')()),
            ('order', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['comm.Order'])),
            ('specification', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalog.Specification'])),
        ))
        db.send_create_signal('comm', ['OrderSpecification'])

        # Adding model 'Basket'
        db.create_table('comm_basket', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
        ))
        db.send_create_signal('comm', ['Basket'])

        # Adding model 'BasketSpecification'
        db.create_table('comm_basketspecification', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('quantity', self.gf('django.db.models.fields.IntegerField')()),
            ('basket', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['comm.Basket'])),
            ('specification', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalog.Specification'])),
        ))
        db.send_create_signal('comm', ['BasketSpecification'])


    def backwards(self, orm):
        
        # Deleting model 'Order'
        db.delete_table('comm_order')

        # Deleting model 'OrderSpecification'
        db.delete_table('comm_orderspecification')

        # Deleting model 'Basket'
        db.delete_table('comm_basket')

        # Deleting model 'BasketSpecification'
        db.delete_table('comm_basketspecification')
