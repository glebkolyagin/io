...
var replaceSearchRadioButtons = {
	init: function() {
		if (document.getElementById("local_form")) {
			document.getElementById("local_form").action = "http://www.dmv.ca.gov/portal/home/dmvsearch.htm";
			document.getElementById("local_form").cof.value = "FORID:9;NB:1";
		}
		if (document.getElementById("ca_form")) {
			document.getElementById("ca_form").action = "http://www.ca.gov/CaSearch/Default.aspx";
